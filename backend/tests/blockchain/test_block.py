...
def test_slowly_mined_block():
    ...
    # as it is in nanoseconds but we converted it to seconds.
...
def test_is_valid_block_hash_bad_block_hash(last_block, block):
    block.hash = '00000000000000000000bbbbaaacc'
